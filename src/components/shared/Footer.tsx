...
const Footer = () => {
    ...
    return (
        <div className="bg-cover bg-no-repeat" style={{ backgroundImage: "url('/images/footer.png')" }}>
            <div className="" >
                    ...
                    <div className="">
                        ...
                        <div className="space-y-4 mb-8">
                            ...
                            <p className="font-sans font-medium text-[16px] text-[#ffff]  text-center">
                                Quality service and outstanding cleaning expertise, all backed up with certificates and after-training
                            </p>
                        </div>
                    ...
                    <div className="container">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:place-items-center gap-4 sm:gap-6 mb-6 sm:mb-8">
                            ...
                            <div className="flex flex-wrap  justify-center gap-3 sm:gap-4 sm:col-span-1 lg:col-span-2 text-center sm:text-left">
                                <a href="#privacy" className="text-sm hover:text-white transition-colors text-blue-50">
                                    Privacy policy
                                </a>
                                <a href="#terms" className="text-sm hover:text-white transition-colors text-blue-50">
                                    Terms & conditions
                                </a>
                                <a href="#faq" className="text-sm hover:text-white transition-colors text-blue-50">
                                    FAQ
                                </a>
                                <a href="#contact" className="text-sm hover:text-white transition-colors text-blue-50">
                                    Contact us
                                </a>
                            </div>
