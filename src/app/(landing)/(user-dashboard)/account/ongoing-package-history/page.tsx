            ...
            <div className="flex flex-col md:flex-row gap-3 md:gap-0 md:justify-between">
              ...
              <div>
                <ul className="list-disc list-inside">
                  <li
                    className={` text-white font-medium text-center text-sm px-4  p-2 rounded-figma-sm bg-[#8A38F5]`}
                  >
                    Ongoing
                  </li>
                </ul>
...
export default OngoingPackageHistory;
